...
namespace Log.Core
{
    public class Log
    {
        ...
        static Log()
        {
            ...
            var pathProject = Directory.GetParent(Directory.GetCurrentDirectory()).FullName;
        ...
        {
            var writeDiagnostics = Convert.ToBoolean(ConfigurationManager.AppSettings["LogCore:EnableDiagnostics"]);
            if (!writeDiagnostics)
            {
                return;
            }
